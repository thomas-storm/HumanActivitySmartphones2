...
NEI_overall <- NEI %>%
              ...
              group_by(year) %>%
              mutate(total.pm25 = mean(Emissions), sd.total.pm25 = sd(Emissions)) %>%
              summarise(total.pm25, sd.total.pm25)

head(NEI_overall)

## simple boxplot to show that Emissions decrease from 1999 to 2008## Peer-graded Assignment: Exploratory Data Analysis Course Project 2
## Plot1
...
## simple barplot of sum of emissons to show decrease from 1999 to 2008
